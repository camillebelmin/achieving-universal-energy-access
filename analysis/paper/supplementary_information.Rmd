...
subtitle: "The energy-population dividend: Evidence from energy-specific population projections"
author: 
...
cook_table %>% 
  ...
  add_footnote(label= "NB2: Although solar energy represents a very small amount of the sample, we did not exclude it from the data.",  notation = "none")
...
p_diff_emissions_spp2_ssp1_univ_elec_2070 = 
  percentage_difference(emissions_ssp2_2070, emissions_ssp1_univ_elec_2070) %>% round()
# 177%
p_diff_emissions_ssp2_ssp1_univ_elec_2050 =   percentage_difference(emissions_ssp2_2050, emissions_ssp1_univ_elec_2050) %>% round()
# 179%
