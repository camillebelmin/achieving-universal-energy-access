...
# Supplementary information about data processing
...
## Supplementary Table 2 {.unnumbered}
...
```{r, fig.cap = "Number of cases in each sub-group of the LCMS dataset for Zambia 2015. The numbers in red show the number of cases for groups with less than 100 cases."}
...
## Supplementary Method 1: Calculation of greenhouse gases emissions {.unnumbered}
...
```{r, fig.cap = "Proportion of the population in three age categories from 2030 to 2050 in the microsimulation, compared with WIC data, for SSP1 scenario."}
...
```{r, fig.cap = "Proportion of the population in three age categories from 2030 to 2050 in the microsimulation, compared with WIC data, for SSP2 scenario."}
...
```{r, fig.cap = "Population pathways from a simulation of the microsimulation model in which the fertility module was replaced by Age-Specific Fertility Rates projections from WIC data, compared with population pathways from the WIC data, for SSP1 and SSP2."}
